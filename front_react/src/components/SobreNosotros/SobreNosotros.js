        ...
        <div className="sobre-nosotros-container">
            <div className="sobre-nosotros-container2">
                ...
                <p className="pnosotros">
                    ...
                    enfrentamiento de aplicaciones, el destino mismo de la eficiencia
                    y la accesibilidad estaba en juego. En un lado del campo de batalla,
                    Rukaya Masmoudi Messaoud, imbuida con el poder del dragón rojo
                    y el fuego ardiente de la determinación, se alzaba como una
                    líder indomable en el ámbito del Front End y la Accesibilidad Web.
                    En el otro lado, Sergio Moreno Valiente, cuya esencia se entrelazaba
                ...
                <p className="pnosotros">
                    ...
                    como las caras de una misma moneda, podrían forjar una alianza capaz
                    de superar cualquier desafío. Unidos por un objetivo común,
                    se sumergieron en la creación de una aplicación que fusionara lo mejor
                    de ambos mundos, una amalgama de accesibilidad impecable
                ...
                <div>
                    ...
                    <div className="rukaya" >
                        ...
                        <p className="pnosotros">
                            ...
                            busca empoderar a todos los usuarios, independientemente
                            de sus habilidades o limitaciones. Con un dominio magistral
                            del Front End, sus habilidades son como llamas ardientes
                            que dan forma a interfaces intuitivas y experiencias e
                            nvolventes. Desde la selección de colores hasta la
                    ...
                    <div className="sergio">
                        ...
                        <p className="pnosotros">
                            ...
                            helado, refrescando los sistemas subyacentes con eficiencia
                            y estabilidad. Cada línea de código es una obra de arte en
                            sí misma, diseñada para funcionar en perfecta armonía con
                            la aplicación en su conjunto. Desde la gestión de datos hasta
                            la optimización del rendimiento, Sergio asegura que todo
                ...
                <p className="pnosotros">
                    ...
                    Su aplicación, imbuida con la esencia de ambos dragones y el fuego
                ...
                <p className="pnosotros">
                    ...
                    que juntos son imparables. Que su triunfo resuene a través de los
                ...
                <p className="pnosotros">
                    ...
                    oscuros, la colaboración y la determinación pueden llevarnos hacia
                    la victoria. En los campos de batalla digitales, como en la vida
                    misma, nunca subestimes el poder de la alianza y la pasión compartida
                    por un objetivo común. ¡Que los dragones te acompañen en todas tus
                    aventuras!
                </p>
            </div>
        </div>
